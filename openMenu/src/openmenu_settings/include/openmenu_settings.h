...
typedef enum CFG_DEFLICKER_DISABLE {
    ...
    DEFLICKER_DISABLE_LIGHT,
    DEFLICKER_DISABLE_MEDIUM,
    DEFLICKER_DISABLE_STRONG,
    DEFLICKER_DISABLE_FULL,
    DEFLICKER_DISABLE_END = DEFLICKER_DISABLE_FULL
} CFG_DEFLICKER_DISABLE;

typedef CFG_REGION region;

enum draw_state { DRAW_UI = 0, DRAW_MULTIDISC, DRAW_EXIT, DRAW_MENU, DRAW_CREDITS, DRAW_CODEBREAKER, DRAW_PSX_LAUNCHER, DRAW_SAVELOAD, DRAW_DCNOW_PLAYERS };
