...
The latest version of **openMenu Virtual Folder Bundle** is [1.0](https://github.com/DerekPascarella/openMenu-Virtual-Folder-Bundle/releases/tag/1.0-ateam).
